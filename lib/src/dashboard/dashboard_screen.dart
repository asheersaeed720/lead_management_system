...
import 'package:lead_management_system/src/dashboard/components/header_text.dart';
import 'package:lead_management_system/src/dashboard/components/list_task_assigned.dart';
import 'package:lead_management_system/src/dashboard/components/list_task_date.dart';
import 'package:lead_management_system/src/dashboard/components/responsive_builder.dart';
import 'package:lead_management_system/src/dashboard/components/search_field.dart';
import 'package:lead_management_system/src/dashboard/components/selection_button.dart';
import 'package:lead_management_system/src/dashboard/components/simple_selection_button.dart';
import 'package:lead_management_system/src/dashboard/components/simple_user_profile.dart';
import 'package:lead_management_system/src/dashboard/components/task_progress.dart';
import 'package:lead_management_system/src/dashboard/components/user_profile.dart';
import 'package:lead_management_system/utils/app_helpers.dart';
...
class DashboardScreen extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:
          (ResponsiveBuilder.isDesktop(context) || kIsWeb) ? null : const _BottomNavbar(),
      body: SafeArea(
