...
class _Button extends StatelessWidget {
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(2), color: Theme.of(context).primaryColor),
        ),
  ...
  Widget _buildIcon() {
    return CircleAvatar(
      radius: 5,
      backgroundColor: (!selected) ? kFontColorPallets[2] : Theme.of(Get.context!).primaryColor,
    );
  }
  ...
  Widget _buildLabel() {
    return Text(
      data,
      style: TextStyle(
        color: (!selected) ? kFontColorPallets[1] : Theme.of(Get.context!).primaryColor,
